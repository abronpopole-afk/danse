...
const GGCLUB_UI_COLORS = {
  ...
  foldButton: { r: 106, g: 30, b: 34, tolerance: 45 },
  callButton: { r: 35, g: 85, b: 50, tolerance: 45 },
  raiseButton: { r: 40, g: 65, b: 110, tolerance: 45 },
  checkButton: { r: 35, g: 85, b: 50, tolerance: 45 },
  allInButton: { r: 135, g: 45, b: 135, tolerance: 45 },
